        ...
        <section className="bg-hero-pattern bg-no-repeat bg-center-x bg-center-y bg-cover">
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                ...
                <div className="mb-8 space-y-4 flex-row justify-center space-x-4">
                    <a href="download" className="inline-flex justify-center items-center py-2 px-4 text-center rounded-[0.65em] bg-rhino-purple hover:scale-105 text-white transition-all text-xl">
                        Download
                    </a>  

                    <a href="#learn" className="inline-flex justify-center items-center py-2 px-4 text-center text-white hover:scale-105 hover:text-rhino-purple transition-all text-xl">
                        Learn more
